      ...
      system: let
        ...
        desktopUnwrapped = pkgs.t3code.unwrapped.overrideAttrs (final: previous: {
          ...
          postPatch = ''
              ...
              substituteInPlace \
                ...
                --replace-fail '"version": "${baseVersion}"' '"version": "${version}"'
              substituteInPlace \
          ...
          pnpmDeps = pkgs.fetchPnpmDeps {
            ...
            pnpm = pkgs.pnpm_11;
            fetcherVersion = 4;
            hash = "sha256-ymBxHmtqYmYNfb45YQ69dHve7hdVXc8pPL3GRqXssw4=";
          };
        });
        server = desktopUnwrapped.overrideAttrs (final: previous: {
          ...
          pnpmDeps = pkgs.fetchPnpmDeps {
            ...
            pnpm = pkgs.pnpm_11;
            fetcherVersion = 4;
            hash = "sha256-uUvlD6mmZI0ssVwjE4HQmxzGMmFtW9es7/zd4+kUbu4=";
          };
          buildPhase = ''
            runHook preBuild
